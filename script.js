  ...
  const accounts = [
    { username: "Cyberbot", password: "123456" },
  ...
  notificationBtn.addEventListener("click", () => {
    Swal.fire({
      title: "Bem Vindo ao Cyber Bot Atenção:Para os usuarios com contas, aconselhamos a criar novas contas para aceder a versao com 92,9% de acertos.USUARIO PARA LOGIN: Cyberbot---SENHA:123456.",
      icon: "info",
